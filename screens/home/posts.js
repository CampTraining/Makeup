        ...
        <>
            ...
            <FlatList
                ...
                renderItem={({ index, item }) => {
                    return (
                        <>
                            <View style={[Styles.postContainer, { backgroundColor: isDark ? "#373737" : "#fff" }]}>
                                    ...
                                    <TouchableOpacity style={Styles.HeaderIcon}
                                        onPress={() => {
                                            isAuth ? (SavedFun(index),
                                                item.isSaved ? add_to_saved(index) :
            ...
            >
                <View style={{ flex: 1, backgroundColor: '#000', justifyContent: "space-between" }}>
                    <TouchableOpacity style={[Styles.heartIconStory, { height: RFValue(60), alignSelf: 'flex-end', marginTop: RFValue(10) }]}                        >
                        <Entypo name="dots-three-vertical"
                            size={ICONS.mdIcon} color={COLOR.White} />
                    </TouchableOpacity>
                    <Image style={{ flex: 1, alignSelf: 'center', resizeMode: "contain" }}
                        source={fullImage.img} >
                    ...
                    <View style={{ height: RFValue(130), paddingLeft: RFValue(22) }}>
                        ...
                        {/* description */}
                        <ScrollView contentContainerStyle={{ paddingEnd: RFValue(20), paddingBottom: RFValue(14) }}>
                            <View >
                                <Text style={{ fontSize: FONTS.h5, color: COLOR.White }}>{fullImage.description} </Text>
